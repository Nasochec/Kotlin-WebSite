...
data class ContextAwareViewRenderer(
    ...
    fun associateContextLens(key: String, lens: RequestContextLens<*>): ContextAwareViewRenderer {
        val newContextLenses = contextLenses + mapOf(key to lens)
        return this.copy(contextLenses = newContextLenses)
    }

    fun associateContextLenses(lenses: Map<String, RequestContextLens<*>>): ContextAwareViewRenderer {
